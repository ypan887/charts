...
The nexec name
*/}}
{{- define "pipelines.nexec.name" -}}
{{- $name := .Release.Name | trunc 29 -}}
{{- printf "%s-%s-nexec" $name .Chart.Name | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{/*
The pipelineSync name
*/}}
{{- define "pipelines.pipesync.name" -}}
{{- $name := .Release.Name | trunc 29 -}}
{{- printf "%s-%s-pipesync" $name .Chart.Name | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{/*
The stepTrigger name
*/}}
...
The runTrigger name
*/}}
{{- define "pipelines.runtrigger.name" -}}
{{- $name := .Release.Name | trunc 29 -}}
{{- printf "%s-%s-runtrigger" $name .Chart.Name | trunc 63 | trimSuffix "-" -}}
{{- end -}}
